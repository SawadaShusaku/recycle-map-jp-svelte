...
#### Scenario: Contact item is available
- **WHEN** the user views the `お問い合わせ` item in the sidebar
- **THEN** the sidebar renders it as a navigation row that indicates it can open another page
...
- **WHEN** the user activates the `お問い合わせ` item
- **THEN** the application navigates to the contact page
